...
<form action="" method="post">
    <div class="card">
        ...
        <div class="des">
    <h4> Remington Cordless Beard Trimmer, All-in-One Beard, Body and Stubble Trimmer,</h4>
  </div>


  <div class="image">
    <img src="imgs/man2.jpg">
  </div>

  <div class="quantity">
    <table class="tab" style=" margin-left: 600px;">
      <tr>
        <td><h5> Price: &nbsp;<span class="priceValue">290 </span>₪</h5></td>
  ...
  <div class="detail">
    ...
    <p> Graphite Coated Blades – Designed for smooth glide comfort<br>

      Self-Sharpening Blades<br>

      30mm Main Blade-  Hair & Beard Trimmer<br>

      Linear NEE Trimmer<br>

      Mini Foil Shaver<br>

      TST Precision Trimmer<br>

      Dual Adjustable Comb for beard & hair (2-20mm)<br>

      1.5mm & 3mm Fixed Combs for stubble & body hair trimming<br>

      Washable Heads<br>

      Premium Storage Pouch<br>

      60 mins Runtime<br>

      10-hour Charge Time<br>

      Cord/Cordless<br>

      Charging LED Indicator</p>
    <br>
