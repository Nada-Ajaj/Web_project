...
<form action="" method="post">
    ...
    <div class="card">
        ...
        <div class="des">
            <h4>Beko Dishwasher 6 Programs, 15 Place Setting, 3 Racks, Stainless Steel.</h4>
        </div>


        <div class="image">
            <img src="imgs/dish33.jpg">
        </div>
        ...
        <div class="detail">
            ...
            <p>LCD display and control through buttons<br>
                Capacity 15 Place Setting<br>
                6 cleaning programs<br>

                Prosmart Inverter motor<br>

                Energy consumption per cycle KWH 0.84<br>

                Reduced water consumption of 9.5 liters<br>

                44db low sound<br>

                3 racks + 3 water sprays<br>

                Color stainless steel<br>

                The feature of opening the door automatically after the end of its cycle<br>

                Scouring (to release steam after the end of the cycle)<br>

                GuardShield feature for further sterilization using steam after<br>

                The end of the ice cycle<br>

                Aquantense for deep cleaning<br>

                Child lock control panel</p>
            <br>
