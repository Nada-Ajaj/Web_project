...
<form action="" method="post">
    ...
    <div class="card">
        ...
        <div class="des">
            <h4>Beko Dishwasher 5 Programs, 14 Place Setting, 2 Racks, Stainless Steel.</h4>
        </div>


        <div class="image">
            <img src="imgs/dish22.jpg">
        </div>

        <div class="quantity">
            <table class="tab" style=" margin-left: 600px;">
                <tr>
                    <td><h5> Price: &nbsp;<span class="priceValue">2400 </span>₪</h5></td>
        ...
        <div class="detail">
            ...
            <p>HygieneShield Technology<br>

                Display Indicator / LED<br>

                14 Place Setting Capacity<br>

                5 Cleaning Programs<br>

                Universal Motor<br>

                Water consumption is 9.12 liters<br>

                Sound Level db49<br>

                4 Foldable Shelves (For Cups).<br>

                Energy Consumption Rating A<br>

                LED screen to display programs<br>

                Time Delay To Delay The End Time Of Washing Dishes<br>

                Control Through Pressure<br>

                Stainless Steel<br></p>
            <br>
