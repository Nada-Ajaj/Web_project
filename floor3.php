...
<form action="" method="post">
    <div class="card">
        ...
        <div class="image">
            <img src="imgs/floor3.jpg">
        </div>

        <div class="quantity">
            <table class="tab" style=" margin-left: 600px;">
                <tr>
                    <td><h5> Price: &nbsp;<span class="priceValue">1568 </span>₪</h5></td>
        ...
        <div class="detail">
            ...
            <p>Motor power - 560 watts<br>

                The suction power of 32 AW<br>

                The color is blue and silver<br>

                Electronic control<br>

                The multi-surface brush that rotates at 3000 cycles<br>

                Wet & Dry Suction<br>

                Self-Cleaning System<br>

                The clean water tank capacity is 0.82 liters<br>

                The capacity of the dirty water tank is 0.62 liters<br>

                The length of the wire is 7.6 meters</p>
            <br>
