...
<form action="" method="post">
  ...
  <div class="des">
    <h4>Trust juicer with slow juice technology 120 watts,bowl capacity 1.2 liters, black color.</h4>
  </div>


  <div class="image">
    <img src="imgs/aa4.jpg">
  </div>

  <div class="quantity">
    <table class="tab" style=" margin-left: 600px;">
      <tr>
        <td><h5> Price: &nbsp;<span class="priceValue">249 </span>₪</h5></td>
  ...
  <div class="detail">
    ...
    <p>
      ...
      Capacity: 1.2 liter bowl<br>

      Speeds: 1 speed, slow juice technology<br>



      Features:

      The Slow Juicer is characterized by the slow squeezing technology to extract the largest amount of juice <br>while preserving the nutritional value.

      Distinctive for healthy food lovers<br>
