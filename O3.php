...
<form action="" method="post">
    <div class="card">
        ...
        <div class="des">
    <h4>Beko Built-In Electric Oven, 60 Cm, 72 Liter Capacity, 13 Programs, 3400 Watts, Black.</h4>
  </div>


  <div class="image">
    <img src="imgs/oo3.jpg">
  </div>
  ...
  <div class="detail">
    ...
    <p>Size: 60 cm<br>
      ...
      Number of Programs: 13 Programs<br>

      Oven capacity: 72 liters<br>

      Heating capacity: 3400 W <br>

      Temperature: up to ◦280<br>

      Energy rating A<br>

      LED display<br>

      5 levels of tray placement<br>

      Removable three-layer glass door<br>

      Light inside the oven<br>

      2 trays + 1 mesh shelf<br>

      Full touch control (special click for each program)<br>

      Child lock feature<br>

      Single telescopic arm<br>

      Soft close feature<br>

      Temperature and time are controlled by Knob<br>

      AeroPerfect Technology</p>
    <br>
