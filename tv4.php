...
<form action="" method="post">
    <div class="card">
        ...
        <div class="des">
            <h4>LG Television UHD UQ75 Series Size 55 Inch 4K UHD Smart WebOS TV.</h4>
        </div>
        ...
        <div class="quantity">
            <table class="tab" style=" margin-left: 600px;">
                <tr>
                    <td><h5> Price: &nbsp;<span class="priceValue">2800 </span>₪</h5></td>
        ...
        <div class="detail">
            ...
            <p>True 4K Ultra High Definition (UHD) TV delivers unrivaled picture,<br>

                color and depth 5th Gen α5 AI Processor 4K resolution with 4K AI upscaling<br>

                22 inch webOS smart TV with ThinQ AI technology, equipped with a magic remote control<br>

                A truly cinematic experience supported by Active HDR (High Dynamic Range),<br>

                Movie Output Mode, and AI Sound Unlimited gaming with <br>

                ALLM (Auto Slow Leap Mode), HDMI 2.0 eARC</p>
            <br>
