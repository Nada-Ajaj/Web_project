...
<form action="" method="post">
    <div class="card">
        ...
        <div class="des">
            <h4>BlueStar USB Fan 4W Wooden.</h4>
        </div>


        <div class="image">
            <img src="imgs/fan11.jpg">
        </div>

        <div class="quantity">
            <table class="tab" style=" margin-left: 600px;">
                <tr>
                    <td><h5> Price: &nbsp;<span class="priceValue">70 </span>₪</h5></td>
        ...
        <div class="detail">
            ...
            <p>4W power<br>
                ...
                Easily connects to any USB socket<br>

                Powerful and quiet<br>

                RPM : 1500/1200 RPM<br>

                Vertical tilt<br>

                Without the need for assembly</p>
            <br>
