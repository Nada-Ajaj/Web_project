...
<form action="" method="post">
    <div class="card">
        ...
        <div class="des">
            <h4>Daphne (Allure) Cordless Hair Straightener Brush 185°, Black.</h4>
        </div>


        <div class="image">
            <img src="imgs/hair44.jpg">
        </div>

        <div class="quantity">
            <table class="tab" style=" margin-left: 600px;">
                <tr>
                    <td><h5> Price: &nbsp;<span class="priceValue">639 </span>₪</h5></td>
        ...
        <div class="detail">
            ...
            <p> Hair Straightener Cordless.<br>

                Lithium battery works up to 30 minutes.<br>

                USB fast charger.<br>

                It heats up to the ideal temperature of 185 degrees.<br>

                Lightweight.<br>

                Auto shut off after 15 minutes if not in use.<br>

                Easy to use and compact design that lasts for a long time.</p>
            <br>
