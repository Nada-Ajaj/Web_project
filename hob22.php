...
<form action="" method="post">
  ...
  <div class="des">
    <h4>Firegas Hi-Tech Built-In Gas Hob 60 Cm, 4 Burners, Black Glass.</h4>
  </div>
  ...
  <div class="quantity">
    <table class="tab" style=" margin-left: 600px;">
      <tr>
        <td><h5> Price: &nbsp;<span class="priceValue">1000</span>₪</h5></td>
  ...
  <div class="detail">
    ...
    <p>Size: 60 cm<br>
      ...
      Pot positions: cast iron<br>

      Triple Burner: Yes<br>

      Electronic torch: Yes<br>

      Colour: black glass<br>

      security system<br>

      Dimensions (width * depth): 59.5 * 52.3<br>

      Dimensions (for installation): Width * Depth: 56 * 49<br>
