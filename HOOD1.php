...
<form action="" method="post">
    <div class="card">
        ...
        <div class="des">
    <h4>Firegas Hi-Tech Built-in Hood 90 Cm, Suction 750 m³/h, Stainless Steel.</h4>
  </div>
  ...
  <div class="quantity">
    <table class="tab" style=" margin-left: 600px;">
      <tr>
        <td><h5> Price: &nbsp;<span class="priceValue">900 </span>₪</h5></td>
  ...
  <div class="detail">
    ...
    <p>The size is 90 cm<br>

      The suction power is 750 m3 / hour<br>

      Built-in kitchen<br>

      3 speeds ,LED lighting number 2<br>

      Rustproof stainless steel construction<br>

      Charcoal filter number 2<br>
