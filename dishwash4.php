...
<form action="" method="post">
    <div class="card">
        ...
        <div class="detail">
            ...
            <p>LCD Display And Touch Control<br>

                15 Place Setting Capacity<br>

                6 Cleaning Programs+ Programs That Can Be Added Through The HomeWhiz App<br>

                Prosmart Inverter Motor<br>

                Low Electricity Consumption Rated A<br>

                Reduced Water Consumption 5.9 Liters<br>

                Low Sound 44db<br>

                3 Shelves + 3 Water Sprayers<br>

                Aquantense For Deep Cleaning<br>

                Gloss Steam For More Cleaning With Steam<br>

                Folding Shelves (For Cups) 4<br>

                Possibility To Control Via Wifi<br>

                The Feature Of Opening The Door Automatically After The End Of The Cleaning Cycle</p>
            <br>
