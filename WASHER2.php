...
<form action="" method="post">
  ...
  <div class="des">
    <h4>Beko Washer Capacity 8 Kg, 14 Programs, Inverter Brushless Motor Save Energy, Dark.</h4>
  </div>
  ...
  <div class="detail">
    ...
    <p>
      ...
      Color: Save Energy, Dark<br>

      Motor: ProSmart Inverter<br>

      Screen: LED<br>

      Number of Programs: 14 ready-to-go programs via Knob Control<br>
      Temperature (Temperature): You can set the temperature and rinsing uniform.<br>
       Spin: You can specify the level of spin speed for each program.<br>
      Child Lock: You can turn on the device.<br>
      Beep On / Off
