...
<form action="" method="post">
  ...
  <div class="image">
    <img src="imgs/cond44.jpg">
  </div>

  <div class="quantity">
    <table class="tab" style=" margin-left: 600px;">
      <tr>
        <td><h5> Price: &nbsp;<span class="priceValue">5000 </span>₪</h5></td>
  ...
  <div class="detail">
    ...
    <p>Capacity: 18,000 BTU (1.5 Ton)<br>

      App Remote Control (Wi-Fi)<br>
