...
<form action="" method="post">
    <div class="card">
        ...
        <div class="des">
            <h4>Hair straightener with thin ceramic plates, black color.</h4>
        </div>


        <div class="image">
            <img src="imgs/hair33.jpg">
        </div>

        <div class="quantity">
            <table class="tab" style=" margin-left: 600px;">
                <tr>
                    <td><h5> Price: &nbsp;<span class="priceValue">89 </span>₪</h5></td>
        ...
        <div class="detail">
            ...
            <p> Power: 35W<br>
                ...
                Floating ceramic plates provide a smooth glide<br>

                This iron uses PTC technology to achieve a high temperature As in salons<br>

                Fast heat up within 30 seconds<br>

                Swivel cord for ease of use and movement in any direction.</p>
            <br>
