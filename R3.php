...
<form action="" method="post">
  ...
  <div class="des">
    <h4>Beko Refrigerator 4 Door Capacity 624 Ltr, Inverter Compressor Save Energy, ​Silver</h4>
  </div>
  ...
  <div class="quantity">
    <table class="tab" style=" margin-left: 600px;">
      <tr>
        <td><h5> Price: &nbsp;<span class="priceValue">7700 </span>₪</h5></td>
  ...
  <div class="detail">
    ...
    <p>EverFresh+    <br>
      Fruit & vegetables fresh for up to 30 day    <br>
      Fresh Zero    <br>
      NeoFrost Dual Cooling    <br>
      2 separate cooling systems, no odour transfer    <br>

      ProSmart Inverter Compressor    <br>
      High efficiency, high durability, low noise    <br>

      IonGuard    <br>
      Fresh-air environment inside your refrigerator    <br>

      External water dispenser</p>
    <br>
