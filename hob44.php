...
<form action="" method="post">
  ...
  <div class="des">
    <h4>Firegas Hi-Tech Built-In Gas Hob 70 Cm, 5 Burners, Black Color.</h4>
  </div>
  ...
  <div class="detail">
    ...
    <p>Size 70 cm<br>
      ...
      High efficiency defendi stoves<br>

      electronic torch<br>

      Comprehensive safety system<br>

      Four burners + three burner stove<br>

      Front controls<br>

      Number of burners: 5<br>

      Product dimensions: 77 x 51 x 4 cm<br>
