...
<form action="" method="post">
    <div class="card">
        ...
        <div class="des">
            <h4>EuroStar Gas Heater Free Standing 9,500BTU, 3 Burners, Black Color.</h4>
        </div>
        ...
        <div class="quantity">
            <table class="tab" style=" margin-left: 600px;">
                <tr>
                    <td><h5> Price: &nbsp;<span class="priceValue">350 </span>₪</h5></td>
        ...
        <div class="detail">
            ...
            <p>Eurostar Gas Cooker, 3 Burners, 9500 BTU, Black</p>
            <br>
