...
<form action="" method="post">
  ...
  <div class="image">
    <img src="imgs/man3.jpg">
  </div>

  <div class="quantity">
    <table class="tab" style=" margin-left: 600px;">
      <tr>
        <td><h5> Price: &nbsp;<span class="priceValue">480 </span>₪</h5></td>
  ...
  <div class="detail">
    ...
    <p> Cord/Cordless Use<br>

      Cordless use up to 90 minutes<br>

      Premium Self-Sharpening Japanese Grade Steel Blades<br>

      Washable removable blade system<br>

      Digital display of running time and charging status<br>

      2 Running Speed - Normal Speed and Auto Turbo Boost<br>

      Convenient roller to set desired length at 1mm intervals<br>

      3 adjustable booster combs in 3-35mm range with 1mm interval<br>

      72 degree cutting in the range of 0.5-35mm<br>

      Minimum cutting height 0.5 mm without combs<br>

      Micro USB charging cable - can be charged from the car<br>

      Powerful V5 engine - 5 times cutting performance</p>
    <br>
