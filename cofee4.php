...
<form action="" method="post">
    <div class="card">
        ...
        <div class="des">
            <h4>Korkmaz Turkish Coffee Machine 400W ,Prepare up to 4 Cups, Red/Chrome Color.</h4>
        </div>


        <div class="image">
            <img src="imgs/cof44.jpg">
        </div>

        <div class="quantity">
            <table class="tab" style=" margin-left: 600px;">
                <tr>
                    <td><h5> Price: &nbsp;<span class="priceValue">270 </span>₪</h5></td>
        ...
        <div class="detail">
            ...
            <p> Color: Red/Chrome<br>

                Power Consumption: 400 watts<br>

                Prepare up to 4 cups<br>

                Bowl Capacity: 500ml<br>

                The machine turns off automatically after giving three signals when your coffee is ready.<br>

                It has a temperature sensor and overflow<br>

                Coffee pot made of stainless steel<br>

                Automatic protection system<br>

                Easy one-touch operation</p>
            <br>
