...
<form action="" method="post">
    ...
    <div class="card">
        ...
        <div class="des">
            <h4>Hemilton Cooler Fan 16 inch, Black Color.</h4>
        </div>


        <div class="image">
            <img src="imgs/fan44.jpg">
        </div>

        <div class="quantity">
            <table class="tab" style=" margin-left: 600px;">
                <tr>
                    <td><h5> Price: &nbsp;<span class="priceValue">100 </span>₪</h5></td>
        ...
        <div class="detail">
            ...
            <p>Fan diameter: 16 inch/ 40cm<br>

                3 speeds to choose from<br>
                ...
                The height of the fan and angle of tilt can be adjusted</p>
            <br>
