...
<form action="" method="post">
  ...
  <div class="des">
    <h4>EVA Washer Capacity 10 kg, 15 Program, Inverter Brushless Motor Save Energy, Dark Gray.</h4>
  </div>
  ...
  <div class="detail">
    ...
    <p>
      ...
      Number of sessions: 1200<br>

      Energy rating: A++ ,LED screen<br>

      Knob Type: Stainless Steel ,Child lock<br>

      Delay the start time / delay the end time of the cycle<br>

      Special function to determine the level of impurities<br>

      Special function to identify the type of impurities<br>

      Special function of the allergen cycle<br>

      Pre-wash function<br>
