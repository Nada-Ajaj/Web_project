...
<form action="" method="post">
    <div class="card">
        ...
        <div class="des">
            <h4>Beko Espresso Coffee Machine 1200W, Stainless Steel, Black Color.</h4>
        </div>


        <div class="image">
            <img src="imgs/cof22.jpg">
        </div>
        ...
        <div class="detail">
            ...
            <p> . Suitable for ground coffee<br>

                ·         Strong pressure to prepare coffee 15 bars<br>

                ·         Ability to prepare coffee to one touch<br>

                ·         Heating power 1200 W<br>

                ·         Removable water tank with a capacity of 1.2 liters<br>

                ·         Steam nozzle for frothing milk<br>

                ·         Removable drip tray for easy cleaning<br>

                ·         Auto shutdown feature<br>

                ·         The possibility of heating a cup of coffee before starting to prepare the coffee (cups are placed on top of the machine) to ensure hot coffee for a longer period<br>
