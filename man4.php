...
<form action="" method="post">
    <div class="card">
        ...
        <div class="des">
    <h4> Carrera 5-in-1 Multifunctional Trimmer for Face, Hair and Body, Grey/Silver.</h4>
  </div>


  <div class="image">
    <img src="imgs/man4.jpg">
  </div>
  ...
  <div class="detail">
    ...
    <p> IPX7 waterproof<br>

      Stainless steel blade<br>

      Corded/wireless operation<br>

      It works for 100-120 minutes after a full charge<br>

      The battery power is 800mAh<br>

      Charging via a USB cable / cable length 100 cm<br>

      Protection from overload and in the event of a large discharge of the battery<br>

      Regarding the main accessories (continue the next page)<br>
