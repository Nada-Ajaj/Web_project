...
<form action="" method="post">
    <div class="card">
        ...
        <div class="des">
            <h4>Hemilton Heater Fireplace 1850W.</h4>
        </div>
        ...
        <div class="detail">
            ...
            <p>Two heating levels - 950W / 1850W <br>

                Safe thermal shutdown device <br>

                Adjustable thermostat control <br>

                High flame effect <br>

                The brightness of the torch effect can be set and can be turned on separately <br>

                Black coating <br>

                1850 watts of power <br>

                Dimensions: 51 cm wide, 31 cm deep, 56 cm high</p>
            <br>
