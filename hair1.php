...
<form action="" method="post">
    <div class="card">
        <input type="hidden" name="product_image" value="hair11.jpg">
        ...
        <div class="des">
            <h4>Trust hair curler 32 mm, black color.</h4>
        </div>


        <div class="image">
            <img src="imgs/hair11.jpg">
        </div>

        <div class="quantity">
            <table class="tab" style=" margin-left: 600px;">
                <tr>
                    <td><h5> Price: &nbsp;<span class="priceValue">99 </span>₪</h5></td>
        ...
        <div class="detail">
            ...
            <p> Maximum temperature 220°C<br>

                Ready to use in 30 seconds<br>

                25mm curling rod for perfect curls<br>

                4 hair protection methods<br>

                Automatic shut-off mechanism after 60 minutes<br>

                Swivel cable for ease of use<br>
