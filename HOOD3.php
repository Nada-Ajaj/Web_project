...
<form action="" method="post">
    <div class="card">
        ...
        <div class="des">
    <h4>Firegas Hi-Tech Wall Mount Hood 60 Cm, Suction 750 m³/h, White Glass.</h4>
  </div>
  ...
  <div class="quantity">
    <table class="tab" style=" margin-left: 600px;">
      <tr>
        <td><h5> Price: &nbsp;<span class="priceValue">1300 </span>₪</h5></td>
  ...
  <div class="detail">
    ...
    <p>60 cm<br>
      ...
      Lighting color control (white / green / red / blue)<br>

      External wall mounted<br>

      LED lighting number 2<br>

      Elegant white glass<br>

      Product dimensions: 60 x 43 x 114 cm<br>

      Made in China<br>

      The warranty is one year</p>
    <br>
