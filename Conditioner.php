...
<div class="main">
  ...
  <form action="" method="post">
    <div class="card">
      <input type="hidden" name="product_image" value="cond7.jpg">
      <input type="hidden" name="product_name" value="Smart RAC Split 1.5 Ton 18,000 BTU">
      <input type="hidden" class="priceValue" name="product_price" value="3300">
      <figure class="image">
        <img src="imgs/cond7.jpg">
        <div class="product-over">
          <input type="submit" class="addToCart"  value="add to cart" name="add_to_cart">
          <a href="detail_page.html" class="more-inf">More Info</a>
        </div>
      ...
      <div class="des">
        <p>Smart RAC Split 1.5 Ton 18,000 BTU, Wi-Fi Control, White Color.</p>
      </div>

      <h3 class="priceValue"> 3300 </h3>
      <h3>₪</h3>
  ...
  <form action="" method="post">
    <div class="card">
      <input type="hidden" name="product_image" value="cond8.jpg">
      <input type="hidden" name="product_name" value="Smart RAC Split 2.15 Ton 26,000 BTU">
      <input type="hidden" class="priceValue" name="product_price" value="4500">
      <figure class="image">
        <img src="imgs/cond8.jpg">
        <div class="product-over">
          <input type="submit" class="addToCart"  value="add to cart" name="add_to_cart">
          <a href="detail_page.html" class="more-inf">More Info</a>
        </div>
      ...
      <div class="des">
        <p>Smart RAC Split 2.15 Ton 26,000 BTU, Wi-Fi Control, White Color.</p>
      </div>
