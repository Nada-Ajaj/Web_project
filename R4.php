...
<form action="" method="post">
  ...
  <div class="des">
    <h4>Beko Refrigerator 4 Door Capacity 626 Ltr, Inverter Compressor Save Energy, Silver.</h4>
  </div>
  ...
  <div class="quantity">
    <table class="tab" style=" margin-left: 600px;">
      <tr>
        <td><h5> Price: &nbsp;<span class="priceValue">6800 </span></h5></td>
  ...
  <div class="detail">
    ...
    <p>EverFresh+<br>
      Fruit & vegetables fresh for up to 30 days<br>
      Fresh Zero<br>
      ...
      IonGuard<br>
      Fresh-air environment inside your refrigerator</p>
    <br>
