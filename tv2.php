...
<form action="" method="post">
    <div class="card">
        ...
        <div class="des">
            <h4>LG Television UHD UQ80 Series Size 70 Inch 4K UHD Smart WebOS TV.</h4>
        </div>
        ...
        <div class="detail">
            ...
            <p>
                ...
                True 4K Ultra HD (UHD) TV delivers picture and color<br>

                5th generation α5 processor with artificial intelligence in 4K<br>

                webOS ThinQ AI Smart TV with Magic Remote<br>

                Cinematic experience supported by HDR (High Dynamic Range)<br>

                Limited gaming through HGiG, ALLM (Auto Slow Mode), HDMI 2.0 eARC</p>
            <br>
