...
<form action="" method="post">
    <div class="card">
        <input type="hidden" name="product_image" value="sm4.jpg">
  ...
  <div class="des">
    <h4>Philips Hand Steamer 1000W, with Water Tank Capacity 120ml, White Color.</h4>
  </div>


  <div class="image">
    <img src="imgs/sm4.jpg">
  </div>

  <div class="quantity">
    <table class="tab" style=" margin-left: 600px;">
      <tr>
        <td><h5> Price: &nbsp;<span class="priceValue">359</span>₪</h5></td>
  ...
  <div class="detail">
    ...
    <p>Continuous steam up to 20g/min<br>

       120ml detachable water tank for easy refilling<br>

       The length of the wire is 2 meters<br>

      Major advantages<br>

      Compact and foldable steamer, easy to use and store<br>
       Ready to use in less than 30 seconds<br>

       No ironing board needed! Save time and effort<br>

      Steam kills 99.9% of bacteria<br>

       Freshens clothes, removes odors and reduces washing<br>

       Safe on all ironable fabrics and no burns guaranteed<br>

      Metal steam base for better steaming results</p>
    <br>
