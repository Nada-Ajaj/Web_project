...
<form action="" method="post">
    <div class="card">
        ...
        <div class="des">
            <h4>Beko Dryer 9Kg, Condenser System, 15 Programs, Dark Stainless.</h4>
        </div>


        <div class="image">
            <img src="imgs/dry22.jpg">
        </div>

        <div class="quantity">
            <table class="tab" style=" margin-left: 600px;">
                <tr>
                    <td><h5> Price: &nbsp;<span class="priceValue">3000 </span>₪</h5></td>
        ...
        <div class="detail">
            ...
            <p>Beko Tumble dryers you can always rely on them to get the job done. If it’s the kids’ clothes,<br>
                your delicate work blouses, or a massive pile of bedding, they’ll always be kept in great condition.<br>

                9kg drum capacity means it’ll easily tackle the laundry pile in a medium-sized household<br>
                B energy rating is kind to the environment and to your utility bills<br>

                With no vent hose needed, any excess water can be emptied on Water Tank and drained away.<br>

                Take your pick from 15 programmes - there’ll always be one that’ll care for the fabrics your drying<br>

                Stainless Steel Drum, Dark Stainless Dryer External Structure</p>
            <br>
