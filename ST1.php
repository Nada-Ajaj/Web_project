...
<form action="" method="post">
  ...
  <div class="des">
    <h4>Beko Steam Iron 2200W, Ceramic Soleplate, Blue/ White Color.</h4>
  </div>


  <div class="image">
    <img src="imgs/sm1.jpg">
  </div>

  <div class="quantity">
    <table class="tab" style=" margin-left: 600px;">
      <tr>
        <td><h5> Price: &nbsp;<span class="priceValue">199 </span>₪</h5></td>
  ...
  <div class="detail">
    ...
    <p>240 ml water tank<br>
       ...
       The rate of steam output is 25 grams / minute continuously during the ironing process<br>

       2200 watt heating power ,Ceramic base<br>

       Anti-drip feature: to protect against dripping water splashes<br>

       Self-cleaning feature: for self-cleaning of the iron<br>
       Vertical steam feature: Steam is released vertically on the clothes<br>

       Shock Steam feature: the ability to release steam through a press of 140 grams / minute<br>
       Warranty: one year</p>
    <br>
