...
<form action="" method="post">
  ...
  <div class="des">
    <h4>Philips Electric Shaver Wet and Dry, Runtime 60 minutes, Gray Dark Color.</h4>
  </div>


  <div class="image">
    <img src="imgs/man1.jpg">
  </div>

  <div class="quantity">
    <table class="tab" style=" margin-left: 600px;">
      <tr>
        <td><h5> Price: &nbsp;<span class="priceValue">509 </span>₪</h5></td>
  ...
  <div class="detail">
    ...
    <p>  Flexible heads rotate 360 degrees<br>

      Wet and dry use<br>

      Runtime 60 minutes<br>

      1 hour full charge<br>

      Integrated pop-up trimmer<br>

      More cutting performance in every stroke<br>

      A shaver with the power to tame beards<br>

      Follows the contours of your face<br>

      Guides hair into the optimal cutting position<br>

      One-touch opening for easy cleaning<br>

      Choose a convenient dry or refreshing wet shave<br>

      Even up your moustache and sideburns<br>

      60 minutes of shaving from a 1 hour charge<br>

      Fully charged in one hour</p>
    <br>
