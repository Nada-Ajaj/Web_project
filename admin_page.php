...
if(isset($_POST['add_product'])){
    ...
    $product_image_folder = 'imgs'.$product_image;

    if(empty($product_name) || empty($product_price) || empty($product_image) || empty($product_quantity)){
        $message[] = 'please fill out all';
    }else{
        $insert = mysqli_query($conn,"INSERT INTO products(name, price, image,quantity) VALUES('$product_name', '$product_price', '$product_image' , '$product_quantity')");
...
<div class="container">
    ...
    <div class="admin-product-form-container" style="margin-top:100px ">
        ...
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <input type="submit" class="ww" name="add_product" value="add product" style="margin: 10px 20% 0;">
        </form>
        ...
        <table class="product-display-table">
            ...
            <?php while($row = mysqli_fetch_assoc($select)){ ?>
                <tr>
                    ...
                    <td>
                        <a class="ww" href="admin_update.php?edit=<?php echo $row['id']; ?>" > <i class="fas fa-edit"></i> edit </a>
                        <a class="ww" href="admin_page.php?delete=<?php echo $row['id']; ?>"> <i class="fas fa-trash"></i> delete </a>
                    </td>
                </tr>
            <?php } ?>
        </table>
