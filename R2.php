...
<form action="" method="post">
  ...
  <div class="des">
    <h4>Beko Refrigerator 4 Door Capacity 580 Ltr, Inverter Compressor Save Energy, White.</h4>
  </div>
  ...
  <div class="quantity">
    <table class="tab" style=" margin-left: 600px;">
      <tr>
        <td><h5> Price: &nbsp;<span class="priceValue">8000 </span></h5></td>
  ...
  <div class="detail">
    ...
    <p>Four door refrigerator<br>

      Capacity: Gross 580 liters/Net 535 liters<br>

      Turn the fridge into a freezer with one touch (MultiZone)<br>

      ProSmart Inverter Compressor<br>

      Keeps fruits and vegetables fresh for up to 30 days (EverFresh+)<br>

      Preserving Vitamin C in Fruits and Vegetables (Active Refreshing Blue Light)<br>

      Fresh air environment inside your refrigerator (IonGuard)<br>

      Multi-directional airflow<br>
