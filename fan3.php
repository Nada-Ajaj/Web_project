...
<form action="" method="post">
    ...
    <div class="card">
        ...
        <div class="des">
            <h4>Midea Cooler Fan Stand 16 inch, White Color.</h4>
        </div>


        <div class="image">
            <img src="imgs/fan33.jpg">
        </div>

        <div class="quantity">
            <table class="tab" style=" margin-left: 600px;">
                <tr>
                    <td><h5> Price: &nbsp;<span class="priceValue">150 </span>₪</h5></td>
        ...
        <div class="detail">
            ...
            <p>3 energy-efficient speeds<br>

                Adjustable in height<br>

                Oscillation for broad room coverage<br>
