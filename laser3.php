...
<form action="" method="post">
    <div class="card">
        <input type="hidden" name="product_image" value="43.jpg">
        <input type="hidden" name="product_name" value="Carrera Cordless Epilator Grey/Rose Gold.">
        <input type="hidden" class="priceValue" name="product_price" value="120">


        <div class="des">
    <h4>Carrera Cordless Epilator, Up to 45 Minutes of Use, Grey/Rose Gold.</h4>
  </div>


  <div class="image">
    <img src="imgs/laser2.jpg">
  </div>

  <div class="quantity">
    <table class="tab" style=" margin-left: 600px;">
      <tr>
        <td><h5> Price: &nbsp;<span class="priceValue">120 </span>₪</h5></td>
  ...
  <div class="detail">
    ...
    <p> Rechargeable<br>
      ...
      Battery power: 800 mAh<br>

      Charging via USB<br>

      Water resistance class IPX4)  The “4” in IPX4 means that the device is protected against splashing<br>

      water from any direction, but not from complete immersion in water and not dust-proof.)<br>

      Number of speeds 2<br>

      Epilator head consisting of 36 tweezers to remove hair with high efficiency<br>

      Hair can be removed up to 5 mm at least.<br>
      Charging time is 2 hours<br>

      Working time 45 minutes on low speed<br>

      Warranty: two years</p>
    <br>
