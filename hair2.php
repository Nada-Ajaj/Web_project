...
<form action="" method="post">
    <div class="card">
        ...
        <div class="des">
            <h4>Chi hair straightener, temperature of 220 degrees Celsius, black color.</h4>
        </div>


        <div class="image">
            <img src="imgs/hair22.jpg">
        </div>

        <div class="quantity">
            <table class="tab" style=" margin-left: 600px;">
                <tr>
                    <td><h5> Price: &nbsp;<span class="priceValue">459 </span>₪</h5></td>
        ...
        <div class="detail">
            ...
            <p> Digital screen for temperature display<br>

                Temperature up to 220°C<br>

                Ceramic plates impregnated with titanium infused with chromium for added durability and smoothness<br>

                3 temperature levels (blue 180 degrees, green 200 degrees, red 220 degrees)<br>

                Fast heating up to its maximum temperature in 60 seconds<br>

                Automatic stop when not in use<br>

                2 meter swivel cord<br>
