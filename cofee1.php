...
<form action="" method="post">
    <div class="card">
        ...
        <div class="des">
            <h4>Beko Dryer 8Kg, Heat Pump System Save Energy, 15 Programs, Dark Stainless.</h4>
        </div>


        <div class="image">
            <img src="imgs/cof11.jpg">
        </div>

        <div class="quantity">
            <table class="tab" >
                <tr>
                    <td><h5> Price: &nbsp;<span class="priceValue">950 </span>₪</h5></td>
        ...
        <div class="detail">
            ...
            <p>.2 Coffee Bowl Stainless steel<br>

                .Coffee Pot Capacity 6 Cups<br>

                .Power 1100W<br>

                .Induction feature for fast and safe heating<br>

                .Electronic Control<br>

                .6 settings for choosing cup size and coffee density<br>

                .Water Tank Capacity 1.5 liter<br>

                .3D Cooking feature to choose the optimal degree of heating for preparing coffee<br>

                .Filling water from the water tank directly without the need to fill the bowl manually<br>

                .Spinjet technology to determine the amount of water and mix it with coffee<br>

                .Sense Cook technology for frothy coffee<br>

                .The possibility of stopping the operation of the machine before the completion of preparing the coffee<br>

                .Anti-spill function to prevent coffee spillage</p>
            <br>
