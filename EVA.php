...
<div class="main" >
    ...
    <form action="" method="post">
        <div class="card">
            ...
            <div class="des">
                <p>EVA Dishwasher 8 Programs, 13 Place Setting, 3 Racks, Black Color.<br><br></p>
            </div>
    ...
    <form action="" method="post">
        <div class="card">
            ...
            <div class="des">
                <p>EVA Dishwasher 8 Programs, 13 Place Setting, 3 Racks, Dark Grey.<br><br></p>
            </div>
