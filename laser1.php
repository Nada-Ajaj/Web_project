...
<form action="" method="post">
    <div class="card">
        ...
        <div class="des">
    <h4>Philips IPL Hair Removal Device 250,000 Flashes With SenseIQ echnology Corded/Cordless Use White.</h4>
  </div>


  <div class="image">
    <img src="imgs/laser1.jpg">
  </div>

  <div class="quantity">
    <table class="tab" style=" margin-left: 600px;">
      <tr>
        <td><h5> Price: &nbsp;<span class="priceValue">2560 </span>₪</h5></td>
  ...
  <div class="detail">
    ...
    <p>Enjoy 6 months of hair-free smooth skin*<br>

      2 intelligent attachments – for optimal results<br>

      With SenseIQ technology<br>

      Body and face<br>

      With SmartSkin sensor<br>

      Both cordless and corded use<br></p>
    <br>
