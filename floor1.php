...
<form action="" method="post">
    <div class="card">
        ...
        <div class="des">
            <h4>Philips Vacuum Cleaner 1900W, 370W Suction Power, Red.</h4>
        </div>


        <div class="image">
            <img src="imgs/floor1.jpg">
        </div>

        <div class="quantity">
            <table class="tab" style=" margin-left: 600px;">
                <tr>
                    <td><h5> Price: &nbsp;<span class="priceValue">699 </span>₪</h5></td>
        ...
        <div class="detail">
            ...
            <p>1900 W<br>
                ...
                Allergy H13 filter<br>

                1900W durable motor for high suction power<br>
                PowerCyclone 5 maintains high performance for longer<br>
                MultiClean nozzle for thorough cleaning on all floors</p>
            <br>
