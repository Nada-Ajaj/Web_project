...
<form action="" method="post">
    <div class="card">
        ...
        <div class="des">
            <h4>EVA Dryer 10Kg, Heat Pump System Save Energy, 15 Programs, Dark Grey.</h4>
        </div>


        <div class="image">
            <img src="imgs/dry33.jpg">
        </div>

        <div class="quantity">
            <table class="tab" style=" margin-left: 600px;">
                <tr>
                    <td><h5> Price: &nbsp;<span class="priceValue">3300 </span>₪</h5></td>
        ...
        <div class="detail">
            ...
            <p>Capacity: 10 Kg<br>
                ...
                Drying type: Heat pump<br>

                Colour: dark grey<br>

                Number of programs: 15<br>

                Basin type: stainless steel<br>
                ...
                Interior LED light in sink<br>

                Keypad lock<br>

                Filter sensor<br>

                Water tank sensor<br>

                The possibility of determining the level of drying<br>

                The possibility of setting the target of drying<br>

                A special reference to the stages of the drying process</p>
            <br>
