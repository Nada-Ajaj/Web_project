...
<form action="" method="post">
    <div class="card">
        ...
        <div class="des">
            <h4>Bissell Spot Clean Carpet and Upholstery Cleaner 750W, Multi Purpose, Blue/Black.</h4>
        </div>


        <div class="image">
            <img src="imgs/floor2.jpg">
        </div>

        <div class="quantity">
            <table class="tab" style=" margin-left: 600px;">
                <tr>
                    <td><h5> Price: &nbsp;<span class="priceValue">949 </span>₪</h5></td>
        ...
        <div class="detail">
            ...
            <p>Motor power - 750 watts<br>

                Color: Titanium Blue<br>

                Dirt bowl capacity is 2.2 liters<br>

                Clean Water Bowl Capacity 2.8 Liters<br>

                The length of the cleaning hose is 1.5 meters<br>
                Warranty (Device) Years: 1<br>

                Warranty (Motor) Years: 2 </p>
            <br>
