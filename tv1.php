...
<form action="" method="post">
    <div class="card">
        ...
        <div class="des">
            <h4>LG Television NanoCell, NANO84 Series, Size 50 Inch 4K UHD, Smart WebOS TV.</h4>
        </div>
        ...
        <div class="detail">
            ...
            <p>Real 4K NANO Cell for Pure colour with Nano Colour, Nano Accuracy<br>

                α5 Gen5 AI Processor 4K with AI 4K upscaling<br>

                ThinQ AI webOS Smart TV with NFC Magic Remote<br>

                True Cinema Experience supported with Active HDR, Film Maker Mode, AI Sound<br>

                Unlimited Gameplay with HGiG, ALLM, HDMI 2.0 eARC</p>
            <br>
