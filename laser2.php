...
<form action="" method="post">
    <div class="card">
        ...
        <div class="des">
    <h4>Philips IPL Hair Removal Device 250,000 Flashes With Skin Tone Sensor Corded Use White.</h4>
  </div>


  <div class="image">
    <img src="imgs/laser3.jpg">
  </div>

  <div class="quantity">
    <table class="tab" style=" margin-left: 600px;">
      <tr>
        <td><h5> Price: &nbsp;<span class="priceValue">2050 </span>₪</h5></td>
  ...
  <div class="detail">
    ...
    <p> 250,000 flashes<br>

      Application areas<br>

      Areas of the body: arms, legs, abdomen, bikini, and armpits<br>

      Facial areas: chin, sideburns, upper lip<br>

      100-240 volts<br>

      Accessories (body attachment, face attachment)<br>

      With skin tone sensor<br>

      15 minutes to treat lower legs<br>
