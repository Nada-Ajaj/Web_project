...
<form action="" method="post">
    <div class="card">
        ...
        <div class="des">
            <h4>Colder Infra Heater 2000W with Remote Control IP65, Silver Color.</h4>
        </div>
        ...
        <div class="quantity">
            <table class="tab" style=" margin-left: 600px;">
                <tr>
                    <td><h5> Price: &nbsp;<span class="priceValue">500 </span>₪</h5></td>
        ...
        <div class="detail">
            ...
            <p>The maximum power is 2000 watts<br>

                Water protection standard: IP65 waterproof suitable for outdoor and indoor use, rainproof<br>

                New type: instant heating with the world's latest and most innovative technology<br>, high energy consumption heating power.<br>

                Suitable for heating: Open space: 16m2 / In closed space: 26m2<br>

                Electricity consumption is about one shekel per hour<br>

                Two control systems: 1500W / 2000W<br>

                Control device: manual / remote control<br>

                Installation: It can be hung on the wall or on a pole<br>

                It is the most energy consuming area in the world</p>
            <br>
