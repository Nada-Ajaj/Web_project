...
<form action="" method="post">
    <div class="card">
        ...
        <div class="des">
            <h4>Beko Espresso Coffee Machine 1350W, Stainless Steel, Black Color.</h4>
        </div>


        <div class="image">
            <img src="imgs/cof33.jpg">
        </div>

        <div class="quantity">
            <table class="tab" style=" margin-left: 600px;">
                <tr>
                    <td><h5> Price: &nbsp;<span class="priceValue">2000 </span>₪</h5></td>
        ...
        <div class="detail">
            ...
            <p>  . 3 in 1 possibility to prepare cappuccino, latte and espresso<br>

                ·        Heating power 1350 W<br>

                ·        Removable water tank with capacity 1.5 liter<br>

                ·        Strong Pressure to prepare coffee 19 bars<br>

                ·        Electronic touch control<br>

                ·        5 levels of coffee grinding<br>

                ·        Auto shutdown feature<br>

                ·        Self-cleaning feature<br>
