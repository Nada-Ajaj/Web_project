...
<form action="" method="post">
  ...
  <div class="des">
    <h4>EVA Washer Capacity 10 kg, 15 Program, Inverter Brushless Motor Save Energy, Black Color.</h4>
  </div>
  ...
  <div class="quantity">
    <table class="tab" style=" margin-left: 600px;">
      <tr>
        <td><h5> Price: &nbsp;<span class="priceValue">2700 </span>₪</h5></td>
  ...
  <div class="detail">
    ...
    <p>
      ...
      Capacity: 10 kg, black color<br>

      Motor: BLDC (electricity-saving inverter motor that works without friction)<br>

      Number of Programs: 15 Ready by Knob Control<br>

      Number of courses: 1400<br>

      Energy rating: A++ ,LED screen<br>

      Knob Type: Stainless Steel<br>

      Child lock ,Delay the start time / delay the end time of the cycle<br>

      Special function to determine the level of impurities<br>

      Special function to identify the type of impurities<br>

      Special function of the allergen cycle ,Pre-wash function<br>

      A special function for an additional washing cycle<br>

      A special function to prepare clothes for ironing</p>
    <br>
