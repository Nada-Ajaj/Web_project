...
<div class="main" >
    ...
    <form action="" method="post">
        <div class="card">
            <input type="hidden" name="product_image" value="42.jpg">
            <input type="hidden" name="product_name" value="Philips Hair Removal Device 250,000 Flashes With Skin Tone Sensor .">
            <input type="hidden" class="priceValue" name="product_price" value="2050">
            <figure class="image">
                <img src="imgs/42.jpg">
                <div class="product-over">
                    <input type="submit" class="addToCart"  value="add to cart" name="add_to_cart">
                    <a href="laser2.php" class="more-inf">More Info</a>
                </div>
            </figure>

            <div class="des">
                <p>Philips IPL Hair Removal Device 250,000 Flashes With Skin Tone Sensor Corded Use White.</p>
            </div>

            <h3 class="priceValue"> 2050 </h3>
            <h3>₪</h3>
    ...
    <form action="" method="post">
        <div class="card">
            ...
            <figure class="image">
                ...
                <div class="product-over">
                    <input type="submit" class="addToCart"  value="add to cart" name="add_to_cart">
                    <a href="laser3.php" class="more-inf">More Info</a>
                </div>
            </figure>

            <div class="des">
                <p>Carrera Cordless Epilator, Up to 45 Minutes of Use, Grey/Rose Gold.</p>
            </div>

            <h3 class="priceValue"> 120 </h3>
            <h3>₪</h3>
