...
<form action="" method="post">
  ...
  <div class="image">
    <img src="imgs/aa3.jpg">
  </div>

  <div class="quantity">
    <table class="tab" style=" margin-left: 600px;">
      <tr>
        <td><h5> Price: &nbsp;<span class="priceValue">1100</span>₪</h5></td>
  ...
  <div class="detail">
    ...
    <p>Minimize damage to delicate vitamins and minerals from heat and processing.  <br>
      Breville’s Cold Spin Technology has been shown to transfer less than 1.8°C <br>
      while extracting juice. And the 1250 watt motor processes even the toughest fruits and vegetables in just seconds.
    <br>
