...
<form action="" method="post">
  ...
  <div class="des">
    <h4>Beko Built-In Electric Oven, 60 Cm, 72 Liter Capacity, 9 Programs, 2800 Watts, Black.</h4>
  </div>


  <div class="image">
    <img src="imgs/oo4.jpg">
  </div>

  <div class="quantity">
    <table class="tab" style=" margin-left: 600px;">
      <tr>
        <td><h5> Price: &nbsp;<span class="priceValue">2500 </span>₪</h5></td>
  ...
  <div class="detail">
    ...
    <p>
      ...
      Number of Programs: 9 Programs <br>

      Oven capacity: 72 liters <br>

      Heating capacity: 2800 W <br>
      ...
      Touch control + Control by Knob <br>
