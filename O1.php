...
<form action="" method="post">
  ...
  <div class="image">
    <img src="imgs/oo1.jpg">
  </div>

  <div class="quantity">
    <table class="tab" style=" margin-left: 600px;">
      <tr>
        <td><h5> Price: &nbsp;<span class="priceValue">3400 </span>₪</h5></td>
  ...
  <div class="detail">
    ...
    <p>Ramadan Program, Keep Food Warm<br>
      ...
      2 Telescopic Guides<br>
      2 Hexagonal Trays To Prevent Food From Sticking, Including A Deep Tray<br>
      2 Grids Trays<br>
      Type Of Front 3-Glazed Door<br>
      25 Preset Cooking Programmes<br>
