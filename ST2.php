...
<form action="" method="post">
  ...
  <div class="des">
    <h4>Beko Steam Iron 2600W, Ceramic Soleplate, Purple/ White Color.</h4>
  </div>


  <div class="image">
    <img src="imgs/sm2.jpg">
  </div>

  <div class="quantity">
    <table class="tab" style=" margin-left: 600px;">
      <tr>
        <td><h5> Price: &nbsp;<span class="priceValue">259</span>₪</h5></td>
  ...
  <div class="detail">
    ...
    <p>240 ml water tank<br>

    The rate of steam output is 35 grams / minute continuously during the ironing process<br>

       2600 watt heating power ,Ceramic base<br>
      Anti-Drip feature: to protect against dripping water spots<br>

       Self-Clean feature: for self-cleaning of the iron<br>

      Vertical steam feature: steam output perpendicular to the clothes<br>

       Shock Steam feature: the ability to release steam through a press at a rate of 150 grams / minute<br>
