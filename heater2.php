...
<form action="" method="post">
    <div class="card">
        ...
        <div class="des">
            <h4>Colder Infra Heater 2000W, White Color.</h4>
        </div>
        ...
        <div class="quantity">
            <table class="tab" style=" margin-left: 600px;">
                <tr>
                    <td><h5> Price: &nbsp;<span class="priceValue">850 </span>₪</h5></td>
        ...
        <div class="detail">
            ...
            <p>Power: 2000 watts<br>

                Heating area: in open spaces 16 square meters. In a closed area: 32 square meters.<br>

                Electricity consumption: about one shekel per hour<br>

                -220-240 volts<br>

                Degree of protection: IP65 waterproof, suitable for outdoor and indoor use, rainproof<br>

                Measurements: 460 x 190 x 75 cm    <br>


                Weight: 2.2 kg    <br>


                Material: Oven-painted aluminium    <br>


                Remote: without remote (comes with on/off switch)    <br>


                Installation type: The possibility of hanging on the wall or placing it on a suitable mobile device.</p>
            <br>
