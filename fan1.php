...
<form action="" method="post">
    <div class="card">
        ...
        <div class="des">
            <h4>Star Fan 2 in One, 120W, 18 Inch, Black Color.</h4>
        </div>


        <div class="image">
            <img src="imgs/fan22.jpg">
        </div>

        <div class="quantity">
            <table class="tab" style=" margin-left: 600px;">
                <tr>
                    <td><h5> Price: &nbsp;<span class="priceValue">300 </span>₪</h5></td>
                    <td>                <input type="submit" class="addToCart"  value="add to cart" name="add_to_cart">
                    </td>
        ...
        <div class="detail">
            ...
            <p>Ideal for industrial halls and kitchens<br>

                Powerful and quiet ball bearing motor<br>

                Power: 120 watts<br>

                Number of revolutions per minute:  1250<br>

                3 speeds and vertical tilt<br>

                Possibility to hang on the wall, including 2 hanging hooks<br>

                Controls control panel for convenient operation<br>

                Ultra-modern wing, more air, quieter</p>
            <br>
