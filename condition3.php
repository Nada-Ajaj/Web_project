...
<form action="" method="post">
    <div class="card">
        ...
        <div class="des">
    <h4>Midea RAC Split Inverter 1.5 Ton 18,000 BTU, Wi-Fi Control, White Color.</h4>
  </div>


  <div class="image">
    <img src="imgs/cond33.jpg">
  </div>

  <div class="quantity">
    <table class="tab" style=" margin-left: 600px;">
      <tr>
        <td><h5> Price: &nbsp;<span class="priceValue">4000 </span>₪</h5></td>
  ...
  <div class="detail">
    ...
    <p>18,000 BTU = 1.5 Ton<br>

      The ability to control the device via wifi<br>

      Inverter motor<br>

      Dual Filter<br>

      Noise level 20 dB<br>
      ...
      Heating capacity 5680W<br>

      Cooling capacity 5680W<br>

      7 fan speed levels</p>
    <br>
