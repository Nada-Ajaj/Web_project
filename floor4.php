...
<form action="" method="post">
    <div class="card">
        ...
        <div class="des">
            <h4>Bissell 800W Deep Cleaning Carpet Vacuum Cleaner, Red/Titanium.</h4>
        </div>


        <div class="image">
            <img src="imgs/floor4.jpg">
        </div>

        <div class="quantity">
            <table class="tab" style=" margin-left: 600px;">
                <tr>
                    <td><h5> Price: &nbsp;<span class="priceValue">1800 </span>₪</h5></td>
        ...
        <div class="detail">
            ...
            <p>Motor power - 800 watts<br>

                Bowl capacity 3.7 liters<br>

                The length of the wire is 7 meters<br>

                2*5 cleaning brushes<br>

                Heat wave technology helps maintain a constant water temperature while cleaning.<br>

                Powerful suction to beat tough dirt<br>

                This vacuum cleaner is light in weight<br>

                Powerful circumferential suction provides an hour of drying time<br>

                Hoses and tools included for cleaning floors</p>
            <br>
